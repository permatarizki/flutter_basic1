...
ProTheme getFullApps() {
  ...
  List<ProTheme> list = [];
  list.add(ProTheme(name: 'Banking', type: 'New', widget: BankingSplash()));
  list.add(ProTheme(name: 'Pro Cricket', type: 'New', widget: PCSplashScreen()));
  list.add(ProTheme(name: 'Hair Salon', type: 'New', widget: BHSplashScreen()));
...
ProTheme getIntegrations() {
  ...
  list.add(ProTheme(name: 'Integration', title_name: 'Integrations', type: 'New', show_cover: false, sub_kits: getIntegration(), darkThemeSupported: true));
...
List<ProTheme> getIntegration() {
  ...
  list.add(ProTheme(name: 'File Picker', show_cover: false, type: 'New', widget: FilePickerScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Image Picker', show_cover: false, type: 'New', widget: ImagePickerScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Video Picker', show_cover: false, type: 'New', widget: VideoPickerScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Local Notification', show_cover: false, type: 'New', widget: LocalNotificationScreen(), darkThemeSupported: true));

    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [Text("File Name:", style: boldTextStyle(size: 18)), 8.width, if (file != null) Text("$fileName", style: TextStyle(fontSize: 18, color: Colors.black)).expand()],
          ).paddingAll(16),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [Text("File Path:", style: boldTextStyle(size: 18)), 8.width, if (file != null) Text("$filePath", style: TextStyle(fontSize: 18, color: Colors.black)).expand()],
          ).paddingAll(16),
          RaisedButton(

      ...
      CustomTheme(
        child: PopupMenuButton(
          ...
          itemBuilder: (_) => [
            PopupMenuItem(
              child: InkWell(
                child: Text('Hybrid',style: primaryTextStyle(),),
                onTap: () {
                  setState(() {
            ...
            PopupMenuItem(
              child: InkWell(
                child: Text('Normal',style: primaryTextStyle(),),
                onTap: () {
                  setState(() {
            ...
            PopupMenuItem(
              child: InkWell(
                child: Text('Satellite',style: primaryTextStyle(),),
                onTap: () {
                  setState(() {
            ...
            PopupMenuItem(
              child: InkWell(
                child: Text('Terrain',style: primaryTextStyle(),),
                onTap: () {
                  setState(() {
